...
const Sidebar = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Sidebar - takes only small left side */}
      <div className="hidden md:flex flex-col w-20 lg:w-64 bg-white border-r border-gray-200 h-screen fixed left-0 top-0 pt-16">
